...
declare type PromiseConstructorLike = new <T>(executor: (resolver: (value?: T) => void, rejecter: (reason?: any) => void) => void) => PromiseLike<T>;
...
interface PromiseLike<T> {
     ...
     */
    then<TResult>(
        onfulfilled: (value: T) => PromiseLike<TResult>,
        onrejected?: ((reason: any) => PromiseLike<TResult>) | undefined | null): PromiseLike<TResult>;
}
...
interface Promise<T> extends PromiseLike<T>{
     ...
     */
    catch<TResult>(onrejected: (reason: any) => PromiseLike<TResult>): Promise<TResult>;
}
...
interface PromiseConstructor {
     ...
     */
    new <T>(executor: (resolver: (value?: T) => void, rejecter: (reason?: any) => void) => void): Promise<T>;
