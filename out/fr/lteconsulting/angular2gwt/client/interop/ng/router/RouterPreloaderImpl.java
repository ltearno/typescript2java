...
public class RouterPreloaderImpl  {
    ...
    @JsConstructor
    public RouterPreloaderImpl(Router router,NgModuleFactoryLoader moduleLoader,Compiler compiler,Injector injector,PreloadingStrategy preloadingStrategy) {}
