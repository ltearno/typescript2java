...
public class RouterLinkWithHrefImpl extends OnChanges {
    ...
    @JsConstructor
    public RouterLinkWithHrefImpl(Router router,ActivatedRoute route,LocationStrategy locationStrategy) {}
