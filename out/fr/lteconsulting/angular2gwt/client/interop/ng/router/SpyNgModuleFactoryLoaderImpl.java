...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.router", name="SpyNgModuleFactoryLoader" )
public class SpyNgModuleFactoryLoaderImpl extends NgModuleFactoryLoader {
    ...
    @JsConstructor
    public SpyNgModuleFactoryLoaderImpl(Compiler compiler) {}
