...
/**
  ...
  **/
@JsType( isNative=true, namespace="ng.core", name="EmbeddedTemplateAst" )
public class EmbeddedTemplateAstImpl extends TemplateAst {
    ...
    @JsConstructor
    public EmbeddedTemplateAstImpl(JsArray<AttrAst> attrs,JsArray<BoundEventAst> outputs,JsArray<ReferenceAst> references,JsArray<VariableAst> variables,JsArray<DirectiveAst> directives,JsArray<ProviderAst> providers,boolean hasViewContainer,JsArray<TemplateAst> children,int ngContentIndex,ParseSourceSpan sourceSpan) {}
