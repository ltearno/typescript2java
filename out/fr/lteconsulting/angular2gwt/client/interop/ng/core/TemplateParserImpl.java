...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="TemplateParser" )
public class TemplateParserImpl  {
    ...
    @JsConstructor
    public TemplateParserImpl(Parser _exprParser,ElementSchemaRegistry _schemaRegistry,I18NHtmlParser _htmlParser,Console _console,JsArray<TemplateAstVisitor> transforms) {}
