...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="DeclareFunctionStmt" )
public class DeclareFunctionStmtImpl extends Statement {
    ...
    @JsConstructor
    public DeclareFunctionStmtImpl(String name,JsArray<FnParam> params,JsArray<Statement> statements,Type /* optional */ type,JsArray</* ng.core.StmtModifier */ int> /* optional */ modifiers) {}
