...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="NoOpAnimationPlayer" )
public class NoOpAnimationPlayerImpl extends AnimationPlayer {
    ...
    @JsConstructor
    public NoOpAnimationPlayerImpl() {}
