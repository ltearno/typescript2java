...
public class ModuleWithComponentFactoriesImpl<T>  {
    ...
    @JsConstructor
    public ModuleWithComponentFactoriesImpl(NgModuleFactory<T> ngModuleFactory,JsArray<ComponentFactory<Object>> componentFactories) {}
}
