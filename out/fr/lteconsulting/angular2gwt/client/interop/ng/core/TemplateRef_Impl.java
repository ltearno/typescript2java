...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="TemplateRef_" )
public class TemplateRef_Impl<C> extends TemplateRef<C> {
    ...
    @JsConstructor
    public TemplateRef_Impl(AppView<Object> _parentView,int _nodeIndex,Object _nativeElement) {}
