...
public interface ProviderElementContext  {
    ...
    void setTransformedHasViewContainer(boolean value);
     ...
     void _getLocalDependency(UNKNOWN_TYPE_NAME_QuestionToken eager);
     void _getDependency(UNKNOWN_TYPE_NAME_QuestionToken eager);
}
