...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="NgTemplateOutlet" )
public class NgTemplateOutletImpl extends OnChanges {
    ...
    @JsConstructor
    public NgTemplateOutletImpl(ViewContainerRef _viewContainerRef) {}
