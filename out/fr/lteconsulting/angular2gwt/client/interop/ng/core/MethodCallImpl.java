...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="MethodCall" )
public class MethodCallImpl extends AST {
    ...
    @JsConstructor
    public MethodCallImpl(ParseSpan span,AST receiver,String name,JsArray<Object> args) {}
