...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="SplitInterpolation" )
public class SplitInterpolationImpl  {
    ...
    @JsConstructor
    public SplitInterpolationImpl(JsArray<String> strings,JsArray<String> expressions,JsArray<Integer> offsets) {}
}
