...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="Expansion" )
public class ExpansionImpl extends Node {
    ...
    @JsConstructor
    public ExpansionImpl(String switchValue,String type,JsArray<ExpansionCase> cases,ParseSourceSpan sourceSpan,ParseSourceSpan switchValueSourceSpan) {}
