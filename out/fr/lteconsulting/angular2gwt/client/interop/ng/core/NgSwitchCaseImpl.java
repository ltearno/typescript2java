...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="NgSwitchCase" )
public class NgSwitchCaseImpl extends DoCheck {
    ...
    @JsConstructor
    public NgSwitchCaseImpl(ViewContainerRef viewContainer,TemplateRef<Object> templateRef,NgSwitch ngSwitch) {}
