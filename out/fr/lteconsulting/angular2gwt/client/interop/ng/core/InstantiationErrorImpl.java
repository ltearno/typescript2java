...
/**
  ...
  * ```
  **/
@JsType( isNative=true, namespace="ng.core", name="InstantiationError" )
public class InstantiationErrorImpl extends WrappedError {
    @JsConstructor
    public InstantiationErrorImpl(ReflectiveInjector injector,Object originalException,Object originalStack,ReflectiveKey key) {}
