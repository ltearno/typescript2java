...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="TagPlaceholder" )
public class TagPlaceholderImpl extends Node {
    @JsProperty(name="tag")
    String getTag();
    @JsProperty(name="tag")
    ...
    @JsConstructor
    public TagPlaceholderImpl(String tag,JsTypedObject<String,String> attrs,String startName,String closeName,JsArray<Node> children,boolean isVoid,ParseSourceSpan sourceSpan) {}
