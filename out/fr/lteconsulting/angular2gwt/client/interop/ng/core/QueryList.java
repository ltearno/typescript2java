...
public interface QueryList<T>  {
    ...
    <U> JsArray<U> map(JsFunction3<T,Integer,JsArray<T>,U> fn);
     JsArray<T> filter(JsFunction3<T,Integer,JsArray<T>,Boolean> fn);
     T find(JsFunction3<T,Integer,JsArray<T>,Boolean> fn);
    <U> U reduce(JsFunction4<U,T,Integer,JsArray<T>,U> fn,U init);
     void forEach(JsFunction3<T,Integer,JsArray<T>,Void> fn);
     boolean some(JsFunction3<T,Integer,JsArray<T>,Boolean> fn);
     JsArray<T> toArray();
     String toString();
     void reset(Array<Object /* UnionType */> res);
