...
public interface SelectorMatcher  {
    ...
    void set_listContexts(Object value);
     void addSelectables(JsArray<CssSelector> cssSelectors,Object /* optional */ callbackCtxt);
     void _addSelectable();
     void _addTerminal();
     void _addPartial();
     boolean match(CssSelector cssSelector,JsFunction2<CssSelector,Object,Void> matchedCallback);
}
