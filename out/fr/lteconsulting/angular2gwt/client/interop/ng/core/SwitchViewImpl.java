...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="SwitchView" )
public class SwitchViewImpl  {
    ...
    @JsConstructor
    public SwitchViewImpl(ViewContainerRef _viewContainerRef,TemplateRef<Object> _templateRef) {}
