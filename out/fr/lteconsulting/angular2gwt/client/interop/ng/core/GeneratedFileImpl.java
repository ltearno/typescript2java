...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="GeneratedFile" )
public class GeneratedFileImpl  {
    ...
    @JsConstructor
    public GeneratedFileImpl(String srcFileUrl,String genFileUrl,String source) {}
}
