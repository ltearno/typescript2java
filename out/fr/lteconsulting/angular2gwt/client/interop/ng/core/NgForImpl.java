...
/**
  ...
  * example.
  **/
@JsType( isNative=true, namespace="ng.core", name="NgFor" )
public class NgForImpl extends DoCheck {
    ...
    @JsConstructor
    public NgForImpl(ViewContainerRef _viewContainer,TemplateRef<NgForRow> _template,IterableDiffers _differs,ChangeDetectorRef _cdr) {}
