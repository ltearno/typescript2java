...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="MockPipeResolver" )
public class MockPipeResolverImpl extends PipeResolver {
    ...
    @JsConstructor
    public MockPipeResolverImpl(Injector _injector) {}
