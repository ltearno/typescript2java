...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ReadPropExpr" )
public class ReadPropExprImpl extends Expression {
    ...
    @JsConstructor
    public ReadPropExprImpl(Expression receiver,String name,Type /* optional */ type) {}
