...
/**
  ...
  **/
@JsType( isNative=true, namespace="ng.core", name="AnimationEntryMetadata" )
public class AnimationEntryMetadataImpl  {
    ...
    @JsConstructor
    public AnimationEntryMetadataImpl(String name,JsArray<AnimationStateMetadata> definitions) {}
}
