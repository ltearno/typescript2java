...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ViewCompileResult" )
public class ViewCompileResultImpl  {
    ...
    @JsConstructor
    public ViewCompileResultImpl(JsArray<Statement> statements,String viewClassVar,Array<Object /* UnionType */> dependencies) {}
}
