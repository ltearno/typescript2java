...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="BinaryOperatorExpr" )
public class BinaryOperatorExprImpl extends Expression {
    ...
    @JsConstructor
    public BinaryOperatorExprImpl(/* ng.core.BinaryOperator */ int operator,Expression lhs,Expression rhs,Type /* optional */ type) {}
