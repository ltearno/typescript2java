...
public interface TransitiveCompileNgModuleMetadata  {
    ...
    void setProviders(JsArray</* TypeLiteral */ Object> value);
     void addProvider(CompileProviderMetadata provider,CompileIdentifierMetadata module);
     void addDirective(CompileIdentifierMetadata id);
     void addExportedDirective(CompileIdentifierMetadata id);
     void addPipe(CompileIdentifierMetadata id);
     void addExportedPipe(CompileIdentifierMetadata id);
     void addModule(CompileTypeMetadata id);
     void addEntryComponent(CompileIdentifierMetadata id);
}
