...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ViewCompiler" )
public class ViewCompilerImpl  {
    ...
    @JsConstructor
    public ViewCompilerImpl(CompilerConfig _genConfig,ElementSchemaRegistry _schemaRegistry) {}
