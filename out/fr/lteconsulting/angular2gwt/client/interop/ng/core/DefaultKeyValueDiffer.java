...
public interface DefaultKeyValueDiffer extends KeyValueDiffer {
    ...
    void setIsDirty(boolean value);
     void forEachItem(JsFunction1<KeyValueChangeRecord,Void> fn);
     void forEachPreviousItem(JsFunction1<KeyValueChangeRecord,Void> fn);
     void forEachChangedItem(JsFunction1<KeyValueChangeRecord,Void> fn);
     void forEachAddedItem(JsFunction1<KeyValueChangeRecord,Void> fn);
     void forEachRemovedItem(JsFunction1<KeyValueChangeRecord,Void> fn);
     Object diff(Object /* UnionType */ map);
     void onDestroy();
     boolean check(Object /* UnionType */ map);
     void _maybeAddToChanges();
     String toString();
}
