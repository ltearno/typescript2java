...
/**
  ...
  * function} is called.
  **/
@JsType( isNative=true, namespace="ng.core", name="AnimationGroupMetadata" )
public class AnimationGroupMetadataImpl extends AnimationWithStepsMetadata {
    @JsProperty(name="_steps")
    Object get_steps();
    @JsProperty(name="_steps")
    void set_steps(Object value);
    @JsConstructor
    public AnimationGroupMetadataImpl(JsArray<AnimationMetadata> _steps) {}
