...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="Extractor" )
public class ExtractorImpl  {
    ...
    @JsConstructor
    public ExtractorImpl(ExtractorHost host,StaticSymbolResolver staticSymbolResolver,MessageBundle messageBundle,CompileMetadataResolver metadataResolver) {}
