...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="TemplateParseResult" )
public class TemplateParseResultImpl  {
    ...
    @JsConstructor
    public TemplateParseResultImpl(JsArray<TemplateAst> /* optional */ templateAst,JsArray<ParseError> /* optional */ errors) {}
}
