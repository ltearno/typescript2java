...
/**
  ...
  **/
@JsType( isNative=true, namespace="ng.core", name="AnimationStateTransitionMetadata" )
public class AnimationStateTransitionMetadataImpl extends AnimationStateMetadata {
    ...
    @JsConstructor
    public AnimationStateTransitionMetadataImpl(String stateChangeExpr,AnimationMetadata steps) {}
}
