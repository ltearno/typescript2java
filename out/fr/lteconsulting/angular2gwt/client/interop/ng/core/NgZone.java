...
public interface NgZone  {
    ...
    public NgZone(/* TypeLiteral */ Object undefined) {}
     Object run(JsFunction<Object> fn);
     Object runGuarded(JsFunction<Object> fn);
     Object runOutsideAngular(JsFunction<Object> fn);
    ...
    void setHasPendingMacrotasks(boolean value);
     void checkStable();
     void forkInnerZoneWithAngularBehavior();
     void onEnter();
     void onLeave();
     void setHasMicrotask();
     void setHasMacrotask();
     void triggerError();
}
