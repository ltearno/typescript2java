...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="Element" )
public class ElementImpl extends Node {
    ...
    @JsConstructor
    public ElementImpl(String name,JsArray<Attribute> attrs,JsArray<Node> children,ParseSourceSpan sourceSpan,ParseSourceSpan startSourceSpan,ParseSourceSpan endSourceSpan) {}
