...
public interface RecursiveExpressionVisitor extends StatementVisitor {
     ...
     void visitAllExpressions(JsArray<Expression> exprs,Object context);
     ...
     void visitAllStatements(JsArray<Statement> stmts,Object context);
}
