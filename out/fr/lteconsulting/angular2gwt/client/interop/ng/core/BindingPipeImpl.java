...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="BindingPipe" )
public class BindingPipeImpl extends AST {
    @JsProperty(name="exp")
    AST getExp();
    @JsProperty(name="exp")
    ...
    @JsConstructor
    public BindingPipeImpl(ParseSpan span,AST exp,String name,JsArray<Object> args) {}
