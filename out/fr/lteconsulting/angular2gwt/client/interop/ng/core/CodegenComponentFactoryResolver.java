...
public interface CodegenComponentFactoryResolver extends ComponentFactoryResolver {
    ...
    <T> ComponentFactory<T> resolveComponentFactory(/* TypeLiteral */ Object component);
}
