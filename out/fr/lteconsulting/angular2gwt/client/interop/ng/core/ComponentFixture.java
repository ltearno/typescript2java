...
public interface ComponentFixture<T>  {
    ...
    public ComponentFixture(ComponentRef<T> componentRef,NgZone ngZone,boolean _autoDetect) {}
     void _tick();
     void detectChanges(boolean /* optional */ checkNoChanges);
     void checkNoChanges();
     void autoDetectChanges(boolean /* optional */ autoDetect);
     boolean isStable();
     Promise<Object> whenStable();
     void destroy();
}
