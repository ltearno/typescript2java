...
public interface ViewContainer  {
    ...
    @JsConstructor
    public ViewContainer(int index,int parentIndex,AppView<Object> parentView,Object nativeElement) {}
    ...
    void setInjector(Injector value);
     void detectChangesInNestedViews(boolean throwOnChange);
     void destroyNestedViews();
    <C> void visitNestedViewRootNodes(JsFunction2<Object,C,Void> cb,C c);
     JsArray<Object> mapNestedViews(Object nestedViewClass,Function callback);
