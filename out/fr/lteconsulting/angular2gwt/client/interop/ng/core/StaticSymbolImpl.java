...
/**
  ...
  **/
@JsType( isNative=true, namespace="ng.core", name="StaticSymbol" )
public class StaticSymbolImpl  {
    ...
    @JsConstructor
    public StaticSymbolImpl(String filePath,String name,JsArray<String> /* optional */ members) {}
}
