...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ClassStmt" )
public class ClassStmtImpl extends Statement {
    ...
    @JsConstructor
    public ClassStmtImpl(String name,Expression parent,JsArray<ClassField> fields,JsArray<ClassGetter> getters,ClassMethod constructorMethod,JsArray<ClassMethod> methods,JsArray</* ng.core.StmtModifier */ int> /* optional */ modifiers) {}
