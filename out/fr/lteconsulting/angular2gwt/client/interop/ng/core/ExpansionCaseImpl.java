...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ExpansionCase" )
public class ExpansionCaseImpl extends Node {
    ...
    @JsConstructor
    public ExpansionCaseImpl(String value,JsArray<Node> expression,ParseSourceSpan sourceSpan,ParseSourceSpan valueSourceSpan,ParseSourceSpan expSourceSpan) {}
