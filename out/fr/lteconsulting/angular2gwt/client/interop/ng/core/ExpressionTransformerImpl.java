...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ExpressionTransformer" )
public class ExpressionTransformerImpl extends StatementVisitor {
    ...
    public native  JsArray<Expression> visitAllExpressions(JsArray<Expression> exprs,Object context);
    ...
    public native  JsArray<Statement> visitAllStatements(JsArray<Statement> stmts,Object context);
}
