...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.core", name="ViewUtils" )
public class ViewUtilsImpl  {
    ...
    @JsConstructor
    public ViewUtilsImpl(RootRenderer _renderer,Sanitizer sanitizer,AnimationQueue animationQueue) {}
}
