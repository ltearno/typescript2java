...
public class SelectMultipleControlValueAccessorImpl extends ControlValueAccessor {
    ...
    @JsConstructor
    public SelectMultipleControlValueAccessorImpl(Renderer _renderer,ElementRef _elementRef) {}
