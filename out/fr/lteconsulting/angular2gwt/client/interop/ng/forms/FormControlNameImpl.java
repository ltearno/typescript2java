...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.forms", name="FormControlName" )
public class FormControlNameImpl extends OnChanges {
    ...
    @JsConstructor
    public FormControlNameImpl(ControlContainer parent,Array<Object /* UnionType */> validators,Array<Object /* UnionType */> asyncValidators,JsArray<ControlValueAccessor> valueAccessors) {}
