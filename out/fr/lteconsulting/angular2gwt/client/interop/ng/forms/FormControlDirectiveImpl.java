...
/**
  ...
  * 
  **/
@JsType( isNative=true, namespace="ng.forms", name="FormControlDirective" )
public class FormControlDirectiveImpl extends OnChanges {
    ...
    @JsConstructor
    public FormControlDirectiveImpl(Array<Object /* UnionType */> validators,Array<Object /* UnionType */> asyncValidators,JsArray<ControlValueAccessor> valueAccessors) {}
