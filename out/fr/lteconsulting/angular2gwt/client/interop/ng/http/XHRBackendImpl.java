...
public class XHRBackendImpl extends ConnectionBackend {
    ...
    @JsConstructor
    public XHRBackendImpl(BrowserXhr _browserXHR,ResponseOptions _baseResponseOptions,XSRFStrategy _xsrfStrategy) {}
