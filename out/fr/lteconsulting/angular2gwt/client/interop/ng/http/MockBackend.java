...
public interface MockBackend extends ConnectionBackend {
    ...
    @JsConstructor
    public MockBackend() {}
     void verifyNoPendingRequests();
     void resolveAllConnections();
     MockConnection createConnection(Request req);
}
