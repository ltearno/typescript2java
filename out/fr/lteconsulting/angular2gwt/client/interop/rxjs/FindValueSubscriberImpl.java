...
public class FindValueSubscriberImpl<T> extends Subscriber<T> {
    ...
    @JsConstructor
    public FindValueSubscriberImpl(Subscriber<T> destination,JsFunction3<T,Integer,Observable<T>,Boolean> predicate,Observable<T> source,boolean yieldIndex,Object /* optional */ thisArg) {}
