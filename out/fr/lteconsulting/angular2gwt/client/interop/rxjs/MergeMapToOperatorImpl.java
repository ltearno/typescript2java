...
public class MergeMapToOperatorImpl<T,I,R> extends Operator<Observable<T>,R> {
    @JsProperty(name="ish")
    Object getIsh();
    @JsProperty(name="ish")
    ...
    @JsConstructor
    public MergeMapToOperatorImpl(/* NO SYMBOL */ObservableInput<I> ish,JsFunction4<T,I,Integer,Integer,R> /* optional */ resultSelector,int /* optional */ concurrent) {}
