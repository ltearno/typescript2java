...
/**
  ...
  **/
@JsType( isNative=true, namespace="rxjs", name="WebSocketSubject" )
public class WebSocketSubjectImpl<T> extends AnonymousSubject<T> {
    @JsProperty(name="url")
    String getUrl();
    @JsProperty(name="url")
    ...
    @JsConstructor
    public WebSocketSubjectImpl(Object /* UnionType */ urlConfigOrSource,Observer<T> /* optional */ destination) {}
