...
public class MergeScanSubscriberImpl<T,R> extends OuterSubscriber<T,R> {
    ...
    @JsConstructor
    public MergeScanSubscriberImpl(Subscriber<R> destination,JsFunction2<R,T,Observable<R>> accumulator,R acc,int concurrent) {}
