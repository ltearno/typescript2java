...
public class SequenceEqualSubscriberImpl<T,R> extends Subscriber<T> {
    ...
    @JsConstructor
    public SequenceEqualSubscriberImpl(Observer<R> destination,Observable<T> compareTo,JsFunction2<T,T,Boolean> comparor) {}
