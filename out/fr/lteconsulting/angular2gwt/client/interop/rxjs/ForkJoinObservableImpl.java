...
/**
  ...
  **/
@JsType( isNative=true, namespace="rxjs", name="ForkJoinObservable" )
public class ForkJoinObservableImpl<T> extends Observable<T> {
    ...
    @JsConstructor
    public ForkJoinObservableImpl(Array</* NO SYMBOL */SubscribableOrPromise<Object>> sources,JsFunction1<Array<Object>,T> /* optional */ resultSelector) {}
