...
public class SubscriptionImpl extends ISubscription {
    @JsProperty(name="EMPTY")
    static Subscription getEMPTY();
    @JsProperty(name="EMPTY")
    static void setEMPTY(Subscription value);
    ...
    @JsConstructor
    public SubscriptionImpl(JsFunction<Void> /* optional */ unsubscribe) {}
