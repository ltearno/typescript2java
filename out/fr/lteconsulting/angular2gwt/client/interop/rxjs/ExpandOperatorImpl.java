...
public class ExpandOperatorImpl<T,R> extends Operator<T,R> {
    ...
    @JsConstructor
    public ExpandOperatorImpl(JsFunction2<T,Integer,Observable<R>> project,int concurrent,IScheduler scheduler) {}
