...
public class ReduceSubscriberImpl<T,R> extends Subscriber<T> {
    ...
    @JsConstructor
    public ReduceSubscriberImpl(Subscriber<R> destination,JsFunction3<R,T,Integer,R> accumulator,R seed,boolean hasSeed) {}
