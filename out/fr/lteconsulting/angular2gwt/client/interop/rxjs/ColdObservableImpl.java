...
/**
  ...
  **/
@JsType( isNative=true, namespace="rxjs", name="ColdObservable" )
public class ColdObservableImpl<T> extends SubscriptionLoggable {
    ...
    @JsConstructor
    public ColdObservableImpl(JsArray<TestMessage> messages,Scheduler scheduler) {}
