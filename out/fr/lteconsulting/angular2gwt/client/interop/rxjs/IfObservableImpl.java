...
/**
  ...
  **/
@JsType( isNative=true, namespace="rxjs", name="IfObservable" )
public class IfObservableImpl<T,R> extends Observable<T> {
    ...
    @JsConstructor
    public IfObservableImpl(JsFunction<Object /* UnionType */> condition,Object /* UnionType */ /* optional */ thenSource,Object /* UnionType */ /* optional */ elseSource) {}
